...
POST on hyväksytty vain "juuri" osoitteeseen *foo.org/api* ja palauttaa 201
sekä uuden IDn.

GET on hyväksytty vain juuri + {id} osoitteeseen *foo.org/api/{id}*
IDn pituus on 8 merkkiä (n. 2,8 biljoona vaihtoehtoa), kaikki muut palauttavat 404 virheen.
